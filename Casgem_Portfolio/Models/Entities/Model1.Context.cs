...
public partial class CasgemPortfolioEntities1 : DbContext
{
    ...
    public virtual DbSet<tbl_socialmedya> tbl_socialmedya { get; set; }

    public virtual DbSet<tbl_video> tbl_video { get; set; }


    public virtual ObjectResult<EmployeeListWithDepartment_Result> EmployeeListWithDepartment()
    {

        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<EmployeeListWithDepartment_Result>("EmployeeListWithDepartment");
    }
